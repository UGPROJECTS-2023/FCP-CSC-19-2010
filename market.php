...
<html lang="en">
 ...
 <div class="jumbotron" style="height:2px; margin-top:-60px;"></div>
...
<div class=" text-white text-center mb-5 bg-info" style="background-color:; height:40px; border-top-left-radius:10px; border-top-right-radius:10px; font-size:26px;"> Market Place</div>
...
<?php
	...
	while ($row = mysqli_fetch_array($sql))
	{
        ...
        <txt class="text-left   text-dark  " style="width:380px; font-size:13px;" >Price: <txt class=" table-bordered" style=" border-radius:2px; "><?php echo $row["price"]; ?></txt><span class=" text-right" style="float:right; font-size:12px;">Available Goods: <txt class=" table-bordered" style=" border-radius:2px;"><?php echo $row["goods"]; ?></txt></span></txt>
           ...
           <a  href="buy.php?id=<?php echo $a=$row["id"]; ?>" class="btn btn-info  mb-2">Buy</a> <a href="addcart.php?id=<?php echo $a=$row["id"]; ?>" class=" btn btn-info  text-left " style="float:right; font-size:14px; ;" >Add Cart</a>
