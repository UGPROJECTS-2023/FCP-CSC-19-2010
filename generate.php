  ...
  ?>
                <tr>
                  ...
                  <td><?php echo $row["description"]; ?></td>
                    ...
                    <td align="center"><a href="bill_product.php?id=<?php echo $row['product_id']; ?>"  class="btn  btn-sm btn-info fa  fa-money fa-sm" ><strong style="font-size: 12px;"> Bill Materials</strong></a></td>
