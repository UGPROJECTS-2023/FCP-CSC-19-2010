...
$sql = mysqli_query($connection,"INSERT INTO stock(name,stock_type,quantity,price_per_product,total_price) VALUES('$name','$caterory','$quantity','$amount','$total')");  
 
echo "<script>alert('Successfully Added!!!'); window.location='generate_invoice.php'</script>";
        ...
        //     $search=$_POST['search'];
               ...
               //   while($row = mysqli_fetch_array($query2,MYSQLI_ASSOC)){
                 ...
                 <tbody>
                   <tr>
                     ...
                     <td><input type="text" id="num1" name="amount" class="field "></td>
                     <td><input type="number" id="num2" name="quantity" class="field"></td>
                     <td><input type="number" id="num3" class="field" name="total"></td>
                     <td><button class="btn btn-primary btn-xs" type="submit" name="add">Add</button></td>
                   </tr>
                 </tbody>
                 </form>
            ...
            <form role="form" action="" method="post" enctype="multipart/form-data">
              <div class="box-body">
               ...
               $query2 = mysqli_query($connection, "SELECT * FROM stock");
                 while($row = mysqli_fetch_array($query2,MYSQLI_ASSOC)){
                ...
                <div class="col-md-3" style="background-color: #eee; height: 180px; border: 1px solid black">
                  <span class=" col-md-4 col-sm-offset-2 " style="font-size: 35px; margin-top: 60px;"   >
                    <?php
                    $query = mysqli_query($connection, " SELECT sum(total_price) FROM stock");
