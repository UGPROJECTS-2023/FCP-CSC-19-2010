...
$sql = mysqli_query($connection,"UPDATE outlet_sales SET customer='$customer' WHERE transaction_id='".$_SESSION['transaction']."'"); 
 
echo "<script>window.location='outlet_invoice.php'</script>";
