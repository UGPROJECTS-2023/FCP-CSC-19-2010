...
<div class="wrapper">
  ...
  <div class="col-md-4 col-md-offset-4">
    <div class=" " style="background-color: #fff; margin-top: 15px;">
      ...
      <img class="" src="images/logo.png" class="" width="100%" height="90" style=" margin-top: -20px; border-radius: 20px;"><br>
        ...
        <table border="1" align="center" class="table table-responsive-md mb-3 table-bordered border-dark col-md-offset-0" style="border: 4px thin black;">
          ...
          <tr style="border: 2px dotted gray; ">
            <td align="center" colspan="4"><span>Designed by SADI BELLO MAIGARI </span><br><b>We appreciate your patronage....Thank you ! </b></td>
            
          </tr>
        </table>
        <span class=" pull-right" > <a href="#" class="btn btn-primary btn-md" onclick="window.print()"> <span class="fa fa-print"></span> Print</a> </span>
      </div>
    </div>
  </div>
