...
$sql = mysqli_query($connection, "INSERT INTO goods (name,picture, price, goods)
VALUES ('$name','$location', '$price','$goods')");
...
<div class="col-sm-12 table-bordered border-white " style="border-radius:10px; height:500px; margin-top:0px; background-color:; padding-left:0px; padding-right:0px;">
<div class=" text-white text-center mb-5 bg-info" style="background-color:; height:40px; border-top-left-radius:10px; border-top-right-radius:10px; font-size:26px;"> ADD GOODS</div>
<div class="row">
